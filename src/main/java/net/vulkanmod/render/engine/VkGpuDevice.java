...
public class VkGpuDevice extends GpuDevice {
    ...
    protected GlShaderModule getOrCompileShader(
            class_2960 resourceLocation, ShaderType shaderType, ShaderDefines shaderDefines, BiFunction<class_2960, ShaderType, String> biFunction
    ) {
    ...
    protected String getCachedShaderSrc(class_2960 resourceLocation, ShaderType shaderType, ShaderDefines shaderDefines, BiFunction<class_2960, ShaderType, String> shaderSourceGetter) {
        ShaderCompilationKey shaderCompilationKey = new ShaderCompilationKey(resourceLocation, shaderType, shaderDefines);
    ...
    private GlShaderModule compileShader(ShaderCompilationKey shaderCompilationKey, BiFunction<class_2960, ShaderType, String> biFunction) {
    ...
    record ShaderCompilationKey(class_2960 id, ShaderType type, ShaderDefines defines) {
